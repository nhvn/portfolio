export const projects = [
  {
    ...
    customLink2:'https://www.reddit.com/r/KarmaMaze/',
    customLinkText2: 'Play on Reddit',
  ...
  { 
    ...
    ongoing: false,
    app: 'Web Application',
    description: <> A generative AI platform for data augmentation and synthetic image generation, awarded <strong>honorable mention</strong> at the {' '} <strong>Dell x NVIDIA HackAI Hackathon</strong>, showcasing the potential of generative AI in data augmentation.</>,
