export const projects = [
  {
    ...
    sect1img2: '/img/beFitArch.png',
    sect1img3: '',
    sect1content: 'For the website, I analyzed the layout and adapted it for a seamless mobile experience, focusing on consistency and ease of navigation across platforms. This is crucial for our fitness app, where user engagement and accessibility are key. I created a detailed architecture diagram to illustrate the interactions between UI, ViewModels, Data Management, and Networking. This diagram highlights key interactions, ensuring a cohesive and efficient user experience on both web and mobile.',
    sect2: 'Methodology',
    sect2img1: '/img/beFit-loginDark.png',
    sect2img2: '/img/beFit-loginLight.png',
    sect2img3: '/img/beFit-dashboard.png',
    sect2content: 'This represents the envisioned design direction for my app. Currently, I am actively developing it using Swift and Xcode to ensure an exceptional user experience. While these designs may evolve, they serve as the foundation for further prototyping.',
    sect3img1: '/img/beFit-loginDark',
    sect3img2: '',
    sect3img3: '',
    sect3content: '',
    finalThoughts: "",
