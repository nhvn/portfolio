export const projects = [
  { 
    ...
    sect1: 'Intro',
    sect1content: 'AugmentAI was developed as a solution to address data scarcity in machine learning projects. With a small dataset, machine learning models may struggle to generalize. By leveraging GANs, AugmentAI generates synthetic images to augment the dataset, improving model performance.',
    sect2: 'Problem',
    sect2content: 'Data scarcity and diversity are major challenges in machine learning. High-quality datasets are often hard to obtain, expensive, and time-consuming to collect, which hinders model accuracy and generalization. Without diverse data, models can overfit or underperform.',
    sect3: 'Solution',
    ...
    sect4sub3: 'External Resources',
    sect4sub3content: 'For more information about this project and its development process, please check out the following resources:',
    sect4sub3link: 'https://devpost.com/software/data-augmentation-no-name-yet',
    sect4sub3linkText: 'HackAI - Dell and NVIDIA Challenge Devpost Article',
    sect4sub4: 'Project Demo',
    sect4sub4content: 'Watch our project demo to see AugmentAI in action:',
    sect4sub4link: 'https://www.youtube.com/watch?v=yqzinpLBngc',
    sect4sub4linkText: 'AugmentAI Project Demo on YouTube',
    sect5: 'Deep Dive',
    ...
    sect5sub3img1: '/img/comingSoon.png',
