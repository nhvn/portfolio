export const projects = [
  { 
    ...
    description: "Embark on an adventure as a daring Snoo, navigating through mysterious, procedurally generated mazes. Collect karma, uncover hidden power-ups, and avoid perilous traps as you explore. The game offers a Casual Mode for practice and a Challenge Mode for competitive play. Built on the Devvit platform, Karma Maze delivers an engaging interactive experience designed for Reddit.",
  ...
  { 
    ...
    customLink2: 'https://www.youtube.com/watch?v=acIyUkKU0uQ&t=6s',
    customLinkText2: 'See Demo on Youtube',
  ...
  //   sect3img3: '',
  //   sect4: '',
  //   sect4content: "", GOES UP TO 20 SECTIONS
  // },