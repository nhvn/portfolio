export const projects = [
  {
    ...
    sect4sub2img1: '/img/comingSoon.png',
    sect5: 'Early Concepts',
    sect5sub1: 'For the website, I analyzed the layout and adapted it for a seamless mobile experience, focusing on consistency and ease of navigation across platforms. This is crucial for our fitness app, where user engagement and accessibility are key.',
    sect5sub1img1: '/img/comingSoon.png',
    sect5sub1img2: '/img/comingSoon.png',
    ...
    sect8sub1: 'Dark Mode',
    sect8sub1img1: '/img/comingSoon.png',
    sect8sub2: 'Dashboard',
    sect8sub2img1: '/img/comingSoon.png',
    sect8sub3: 'Workout Tracking',
    sect8sub3img1: '/img/comingSoon.png',
    sect8sub4: 'Weight Tracking',
    sect8sub4img1: '/img/comingSoon.png',
    sect8sub5: 'Diet Overview',
    sect8sub5img1: '/img/comingSoon.png',
    sect9: 'Future Steps',
